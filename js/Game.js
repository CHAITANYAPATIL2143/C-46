class Game {
  ...
  start() {
    ...
    [
      {x: width / 2 - 250, y: height - 3333, image: obstacle2Image},
      {x: width / 2 + 250, y: height - 2222, image: obstacle2Image},
      {x: width / 2 - 220, y: height - 4500, image: obstacle2Image},
      {x: width / 2 - 250, y: height - 3250, image: obstacle2Image},
      {x: width / 2 - 110, y: height - 1230, image: obstacle2Image},
    ...
    this.addSprites(obstacle2,obstacle2Position.length,obstacle2Image,0.04,obstacle2Position)
  }
